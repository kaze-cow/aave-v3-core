...
contract Pool is VersionedInitializable, PoolStorage, IPool {
    ...
    function supply(address asset, uint256 amount, address onBehalfOf, uint16 referralCode) public virtual override {
        SupplyLogic.executeSupply(
            ...
            DataTypes.ExecuteSupplyParams({
                asset: asset, amount: amount, onBehalfOf: onBehalfOf, referralCode: referralCode
            })
        );
    }
    ...
    function flagForLiquidation(
        ...
        LiquidationLogic.executeFlagForLiquidation(_reserves, _reservesList, _usersConfig, _eModeCategories,
    ...
    function setUserEMode(uint8 categoryId) external virtual override {
        EModeLogic.executeSetUserEMode(
            ...
            DataTypes.ExecuteSetUserEModeParams({
                reservesCount: _reservesCount, oracle: ADDRESSES_PROVIDER.getPriceOracle(), categoryId: categoryId
            })
        );
    }
